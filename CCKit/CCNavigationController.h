...
- (void)navigationController:(CCNavigationController *)navigationController willShowNode:(CCNode<CCRGBAProtocol> *)node animated:(BOOL)animated;

// Called when a navigation controller has finished showing a node (after animation).
- (void)navigationController:(CCNavigationController *)navigationController didShowNode:(CCNode<CCRGBAProtocol> *)node animated:(BOOL)animated;
...
@property (nonatomic, readonly) CCNode<CCRGBAProtocol> *topNode;
...
- (CCNode<CCRGBAProtocol> *)popNodeAnimated:(BOOL)animated;
